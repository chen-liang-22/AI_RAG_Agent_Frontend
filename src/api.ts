...
export async function uploadTrainingKnowledge(payload: TrainingKnowledgeUploadPayload) { // 上传销售训练知识并生成待发布预览
  ...
  // model_mode 只影响资料切分阶段的 LLM 兜底；规则切分和向量 embedding 不使用它。
