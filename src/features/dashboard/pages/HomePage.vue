...
import { trainingKnowledgeSplitterLabel } from '../../sales-training/composables/trainingKnowledgeDisplay'
import {
...
const trainingKnowledgeBatchKeywordInput = ref('') // 销售训练资料文件名搜索输入值
const trainingKnowledgeBatchKeyword = ref('') // 销售训练资料文件名搜索实际查询值
...
const trainingKnowledgeUploadQualitySplitText = computed(() => trainingKnowledgeSplitterLabel(trainingKnowledgeUploadQualityReport.value))
...
async function refreshTrainingKnowledgeBatches() { // 刷新首页弹窗内的销售训练资料批次列表
  ...
  try {
    const response = await listTrainingKnowledgeBatches(
      trainingKnowledgeBatchPage.value,
      trainingKnowledgeDialogBatchPageSize,
      trainingKnowledgeBatchKeyword.value,
    )
...
async function searchTrainingKnowledgeBatches(keyword: string) { // 按文件名查询销售训练资料批次
  trainingKnowledgeBatchKeyword.value = keyword.trim()
  trainingKnowledgeBatchKeywordInput.value = trainingKnowledgeBatchKeyword.value
  trainingKnowledgeBatchPage.value = 1
  await refreshTrainingKnowledgeBatches()
}
    ...
    >
      ...
      <section v-else class="knowledge-mode-panel training-knowledge-dialog-body">
        ...
        <TrainingKnowledgeWorkspace
          ...
          v-model:batch-keyword-input="trainingKnowledgeBatchKeywordInput"
          ...
          @search-batches="searchTrainingKnowledgeBatches"
          @publish-batch="publishTrainingKnowledgeFileBatch"
          @reparse-batch="reparseTrainingKnowledgeFileBatch"
